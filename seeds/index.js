...
const seedDB = async () => {
	...
	for (let i = 0; i < 300; i++) {
		...
		const camp = new Campground({
			...
			description:
				"Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo suscipit numquam molestiae dicta earum quaerat magni tempore beatae laborum placeat nulla consequatur, neque veritatis consequuntur officiis ad assumenda vitae quas?",
			price,
			geometry: {
				type: "Point",
				coordinates: [
